...
func (p *BaseResp) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "base_resp")
	if p != nil {
...
func (p *BaseResp) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("base_resp")
	if p != nil {
		l += p.field1Length()
		l += p.field2Length()
	}
...
func (p *NilResp) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
// for compatibility
func (p *NilResp) FastWrite(buf []byte) int {
	return 0
}

func (p *NilResp) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "nil_resp")
	if p != nil {
	}
	offset += bthrift.Binary.WriteFieldStop(buf[offset:])
	offset += bthrift.Binary.WriteStructEnd(buf[offset:])
...
func (p *NilResp) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("nil_resp")
	if p != nil {
	}
	l += bthrift.Binary.FieldStopLength()
	l += bthrift.Binary.StructEndLength()
